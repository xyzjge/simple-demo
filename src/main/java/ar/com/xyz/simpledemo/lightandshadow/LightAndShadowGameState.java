 ...
 *
 */
public class LightAndShadowGameState extends AbstractGameState implements CrushHandler /*, InputHandler */{
	...
	public LightAndShadowGameState(AbstractMainGameLoop mainGameLoop) {
		super(mainGameLoop);
		loadPlayerAndCamera() ;
